...
<%
	...
	Effector effector = dataProvider.getEffector(effectorId); 
...
<title>Collection of regulogs controlled by <%= effector.getName() %></title>
...
<div id="page">
	...
	<div id="content"> 
			<div class="introduction">
				<h1>Collection of regulogs controlled by <span class="titleItem"><%= effector.getName() %></span></h1>			
			</div> 
